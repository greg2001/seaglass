...
't specify.
    ...
    @Override
    protected void doPaint(Graphics2D g, JComponentSegmentStatus segmentStatus = SegmentStatus.NONE;
        Object buttonType = c.getClientProperty("JButton.buttonType");
        if ("segmented".equals(buttonType) || "segmentedTextured".equals(buttonType if ("segmented".equals(c.getClientProperty("JButton.buttonType"))) {
